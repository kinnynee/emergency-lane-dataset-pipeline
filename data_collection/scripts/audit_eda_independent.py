...
def findings_rows(
    ...
    return [
        ...
        },
        {
            ...
            "severity": "HIGH",
            "category": "CACHE",
            "title": "Resume cache has no code/config/raw-data fingerprint",
            "evidence": "Cache key contains only dataset and sample size; commit/config/source checksums are absent.",
            "impact": "A changed parser or mapping can silently reuse stale results.",
            "recommended_fix": "Version cache with parser/config/source hashes and reject mismatches.",
            "status": "OPEN",
        },
        {
            "finding_id": "AUD-003",
