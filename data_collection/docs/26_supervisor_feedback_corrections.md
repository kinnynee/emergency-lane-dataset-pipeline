...
| Gộp một lớp vehicle | Giữ mọi xe cơ giới kể cả xe máy; bỏ người/xe đạp; giữ nhãn gốc; giữ và review `others` | `vehicle_class_mapping.yaml`, `ua_others_sample_review.csv` |
