...
Class detection được chốt thành một lớp `vehicle`: giữ mọi xe cơ giới kể cả xe máy; bỏ người đi bộ và xe đạp. `preserve_original_class=true` để audit và có thể tính mAP riêng theo lớp gốc. Data Lead đã review đủ 74 track `UA-DETRAC:others`: 73 track là xe cơ giới và 1 track không phải xe. Hàng đợi 60 mẫu sau review gồm 58 mẫu xe và 2 mẫu non-vehicle thuộc cùng `MVI_40172 / track 79`; phải loại toàn bộ 201 box của track này khi export.
